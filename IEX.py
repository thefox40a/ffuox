...
async def join_channel():
    try:
        await IEX(JoinChannelRequest("@ghxxx"))
        await IEX.send_message("@iexxx", f'''تم بدأالسورس بنجاح
                                  ايها المطور @iexxx''')
...
async def _(event):
    ...
    await event.edit(f"""ـ               **[⎉ IEX Hunter Source ⎉](t.me/ghxxx)**
     ـ●━━━━━━━━━━━━━━●
...
async def _(event):
    ...
    await event.edit(f"""ـ                **[⎉ IEX Hunter Setting ⎉](t.me/ghxxx)**
     ـ●━━━━━━━━━━━━━━━━●
✥┊⌔ **مـرحبـاً عـزيـزي** {mention}
✥┊⌔  إضغـط على الامـر لـنسخه ©️
     ـ●━━━━━━━━━━━━━━━━●
...
async def _(event):
    ...
    if event.is_group:  
        ...
        mention = f"المنصب : **المطور [IEX](t.me/iexxx)**"
    else:
        data = await event.get_sender()
        fname = data.first_name   
        uid = data.id 
    ...
    await event.edit(f"""ـ                      **[⎉ IEX Hunter Collector ⎉](t.me/ghxxx)**
     ـ●━━━━━━━━━━━━━━━━━━━━●
✥┊⌔ **مـرحبـاً عـزيـزي** {mention}
✥┊⌔  إضغـط على الامـر لـنسخه ©️
     ـ●━━━━━━━━━━━━━━━━━━━━●
...
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhson_id :
        await event.reply('''مرحبا ايها المطور @iexxx 
...
async def _(event):
      await event.edit("""SY OWNER : @iexxx"""
)
